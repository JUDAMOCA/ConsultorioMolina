...
import { revalidateServices, revalidateClinicInfo, revalidateGallery } from '@/app/actions'
...
// ─────────────────────────────────────────────
// Panel principal (interactivo) – datos iniciales por props
// ─────────────────────────────────────────────
export default function PanelDashboard({ initialAppointments }: { initialAppointments: any[] }) {
  ...
  const [stats, setStats] = useState(() => computeStats(initialAppointments))
  ...
  // ── Refresh appointments + stats (post-mutation)
